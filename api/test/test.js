...
const FAKE_TOKEN                    = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InVzZXJAdGVzdC5jb20ifQ.c9i-82vqIMQtgzLG1t6Q_57CzC2knFXBM7r_5YOInaE';
    ...
    it('Login - check token decode | POST /login', done => {
        ...
        return request( server )
            ...
            .end( (err, res) => {
                ...
                const decodedUsername =  res.body && res.body.auth && decodeJWT( res.body.auth.token );
