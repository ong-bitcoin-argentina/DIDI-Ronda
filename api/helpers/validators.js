...
exports.limitDate           = check('limitDate', 'Valid date (YYYY/MM/DD) greater than now').toDate().isAfter()
exports.startDate           = check('startDate', 'Valid date (YYYY/MM/DD) greater than limitDate').toDate()
                            .custom((value, { req }) => {
                                return moment(value).isSameOrAfter( req.body.limitDate );
                            })

exports.firstPaymentDate    = check('firstPaymentDate', 'Valid date (YYYY/MM/DD) greater than startDate').toDate()
                            .custom((value, { req }) => {
                                return moment(value).isAfter( req.body.startDate );
                            })
