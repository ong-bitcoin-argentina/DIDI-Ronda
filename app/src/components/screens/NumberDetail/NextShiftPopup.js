...
const NextShiftPopup = props => {
    ...
    return (
        <RoundPopUp
            onRef={ props.onRef }
            titleText={ roundName }
            icon={ <Icon type="MaterialIcons" name="filter-tilt-shift" style={ styles.popupIcon } /> }
            ...
            <View style={{width:'100%'}}>
                <Text style={ styles.textChilds }>{ `El siguiente número #${number+1} no tiene participante asignado.` }</Text>
