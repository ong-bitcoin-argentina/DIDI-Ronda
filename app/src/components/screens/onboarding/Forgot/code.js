  ...
  _loading = () => {
    ...
    if( props.valid !== null ){
      ...
      if( props.valid ){
        ...
        props.clean()
        props.navigation.navigate("NewPassword", {token: code, username: username});
        ...
        <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
          <View style={styles.formContainer}>
            <View style={styles.titleContainer}>
                ...
                <TouchableOpacity onPress={_goToMail} style={[styles.button, { width: 200, backgroundColor: colors.mainBlue, flexDirection: 'row', justifyContent: 'center'}]}>
