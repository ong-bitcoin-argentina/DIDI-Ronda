...
const NewPassword = (props) => {
    ...
    if(props.changed){ 
        ...
        return ( <Success text={"Tu contraseña se cambió con exito!"} callback={() => props.navigation.navigate('Login')}/> )
        ...
        <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
          <View style={styles.formContainer}>
            <View style={styles.titleContainer}>
                ...
                <Button onPress={_sendPassword} style={[styles.button, { width: 200,flexDirection: 'row', justifyContent: 'center'}]}>
